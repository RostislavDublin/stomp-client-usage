...
public class UseWildcardSymbolsPoundAndStar {
    ...
    private static String client1_queueToSubscribeOn = "/queue/#";

    private static String client2_subscriptionId = "client2-subscription-2";
    private static String client2_queueToSubscribeOn = "/queue/start/*";

    private static String client3_subscriptionId = "client3-subscription-3";
    private static String client3_queueToSubscribeOn = "/queue/*";

    private static String client4_destination1 = "/queue/start/alpha";
    private static String client4_destination2 = "/queue/start/gamma";
    private static String client4_destination3 = "/queue/theta";
    private static String client4_destination4 = "/queue/end/omega";
    ...
    public static void main(String[] args) {
        ...
        client2.subscribeAutoAck(client3_queueToSubscribeOn, client3_subscriptionId, event -> {
        ...
        client4.send(client4_destination1, "This is for queue ["+client4_destination1+"] subscribers.");
        Helper.sleep(10000);

        client4.send(client4_destination2, "This is for queue ["+client4_destination2+"] subscribers.");
        Helper.sleep(10000);

        client4.send(client4_destination3, "This is for queue ["+client4_destination3+"] subscribers.");
        Helper.sleep(10000);

        client4.send(client4_destination4, "This is for queue ["+client4_destination4+"] subscribers.");
        Helper.sleep(10000);
